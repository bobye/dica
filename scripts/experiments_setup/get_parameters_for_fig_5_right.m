function [c0,D1,c1,K1,D2,c2,K2,L,M,N,nruns] = get_parameters_for_fig_5_right
%GET_PARAMETERS_FOR_FIG_5_RIGHT Returns the parameters for the semi toy
% data from Figure 5 (rigth) of our paper.
%
% [c0,D1,c1,K1,D2,c2,K2,L,M,N,nruns] = get_parameters_for_fig_5_right
%
% Output:
