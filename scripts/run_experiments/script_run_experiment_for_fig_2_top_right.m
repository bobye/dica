function script_run_experiment_for_fig_2_top_right(dir_root)
%SCRIPT_RUN_EXPERIMENT_FOR_FIG_2_TOP_RIGHT

  % for reproducibility
  rng('default')
  rng(1)

  [c0,~,~,K1,~,~,K2,~,~,Ns,nruns] = get_parameters_for_fig_2_top_right;
  dir_exp_1 = strcat(dir_root,'/fig_2_top_right/K10');
  
  dir_exp_2 = strcat(dir_root,'/fig_2_top_right/K90');
  ...
  compute_allerrors_for_fig_2_top_right(dir_root)
