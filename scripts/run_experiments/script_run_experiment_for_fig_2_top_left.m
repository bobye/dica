function script_run_experiment_for_fig_2_top_left(dir_root)
%SCRIPT_RUN_EXPERIMENT_FOR_FIG_2_TOP_LEFT

  % for reproducibility
  rng('default')
  rng(1)

  [c0,~,~,K1,~,~,K2,~,~,Ns,~,nruns] = get_parameters_for_fig_2_top_left;
  ...
  compute_allerrors_for_fig_2_top_left(dir_root)
