function script_run_experiment_for_fig_5_right(dir_root)
%SCRIPT_RUN_EXPERIMENT_FOR_FIG_5_RIGHT

  % for reproducibility
  rng('default')
  rng(1)

  [~,~,~,K1,~,~,K2,~,~,N,nruns] = get_parameters_for_fig_5_right;
  ...
  compute_allerrors_for_fig_5_right(dir_root)
