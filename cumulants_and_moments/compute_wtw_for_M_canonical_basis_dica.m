...
% Copyright 2015, Anastasia Podosinnikova
  ...
  warning(strcat('This function is provided for testing purpoces o', ...
                 'r for reproducing the results of our paper. It i', ...
                 's significantly slower than other alternatives.') )
  STR = input('Do you want to continue execution? (y/n)','s');
